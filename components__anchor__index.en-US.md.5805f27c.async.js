...
export default App;
`,description:"<p>The simplest usage.</p>"}},{demo:{id:"components-anchor-demo-static"},previewerProps:{title:"Static Anchor",filename:"components/anchor/demo/static.tsx",jsx:`import { Anchor } from 'antd';
const App = () => (
  <Anchor
    affix={false}
    items={[
