...
export default App;
`,description:"<p>Use <code>open</code> prop to control the display of the card.</p>"}},{demo:{id:"components-popover-demo-arrow-point-at-center"},previewerProps:{title:"Arrow pointing",filename:"components/popover/demo/arrow-point-at-center.tsx",jsx:`import { Button, Popover, Space } from 'antd';
const content = (
  <>
    <p>Content</p>
    <p>Content</p>
