"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[4882],{615:function(r,o,t){t.r(o);var p=t(2143),v=t(50250),Z=t(59378),m=t(8910),a=t(74775),l=t(5937),h=t(2068),_=t(74399),f=t(63942),g=t(16073),b=t(24628),S=t(19260),x=t(56140),d=t(5388),y=t(49545),w=t(6965),C=t(49706),P=t(95127),A=t(74418),O=t(73024),u=t(94065),s=t(67294),e=t(96923);function i(){var c=(0,u.eL)(),n=c.texts;return(0,e.tZ)(u.dY,null,(0,e.tZ)(s.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value,(0,e.tZ)("code",null,n[2].value),n[3].value),(0,e.tZ)("li",null,n[4].value,(0,e.tZ)(u.rU,{to:"/components/radio/"},n[5].value),n[6].value)),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(d.Z,{items:[{demo:{id:"components-select-demo-basic"},previewerProps:{title:"Basic Usage",filename:"components/select/demo/basic.tsx",jsx:`import { Select, Space } from 'antd';
...
export default App;
`,description:"<p>Search the options while expanded.</p>"}},{demo:{id:"components-select-demo-multiple"},previewerProps:{title:"multiple selection",filename:"components/select/demo/multiple.tsx",jsx:`import { Select, Space } from 'antd';
const options = [];
for (let i = 10; i < 36; i++) {
  options.push({
...
export default App;
`,description:"<p>Multiple selection, selecting from existing items.</p>"}},{demo:{id:"components-select-demo-size"},previewerProps:{title:"Sizes",filename:"components/select/demo/size.tsx",jsx:`import { Radio, Select, Space } from 'antd';
...
export default App;
`,description:"<p>Specify the prop name of Option which will be rendered in select box.</p>"}},{demo:{id:"components-select-demo-search-sort"},previewerProps:{title:"Search with sort",filename:"components/select/demo/search-sort.tsx",jsx:`import { Select } from 'antd';
const App = () => (
  <Select
    showSearch
    style={{
...
export default App;
`,description:"<p>Using <code>OptGroup</code> to group the options.</p>"}},{demo:{id:"components-select-demo-coordinate"},previewerProps:{title:"coordinate",filename:"components/select/demo/coordinate.tsx",jsx:`import { Select, Space } from 'antd';
import { useState } from 'react';
...
export default App;
`,description:"<p>suffix icon.</p>"}},{demo:{id:"components-select-demo-custom-dropdown-menu"},previewerProps:{title:"Custom dropdown",filename:"components/select/demo/custom-dropdown-menu.tsx",jsx:`import { PlusOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Hide already selected options in the dropdown.</p>"}},{demo:{id:"components-select-demo-bordered"},previewerProps:{title:"Bordered-less",filename:"components/select/demo/bordered.tsx",jsx:`import { Select, Space } from 'antd';
const App = () => (
  <Space wrap>
    <Select
      defaultValue="lucy"
...
export default App;
`,description:"<p>Add status to Select with <code>status</code>, which could be <code>error</code> or <code>warning</code>.</p>"}},{demo:{id:"components-select-demo-placement"},previewerProps:{title:"Placement",filename:"components/select/demo/placement.tsx",jsx:`import { Radio, Select } from 'antd';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>You can manually specify the position of the popup via <code>placement</code>.</p>"}},{demo:{id:"components-select-demo-debug"},previewerProps:{debug:!0,title:"4.0 Debug",filename:"components/select/demo/debug.tsx",jsx:`import { Button, Input, Select, Space } from 'antd';
const style = {
  width: 500,
  position: 'relative',
  zIndex: 1,
...
export default App;
`,description:"<p>Debug Usage.</p>"}},{demo:{id:"components-select-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/select/demo/render-panel.tsx",jsx:`import { Select, Space, Switch } from 'antd';
